$(document).ready(function() {
    ...
    reload_card = function(data) {
        ...
        +
        '         <button name="" id="card-button-update-title"class="btn btn-secondary card-button-add-description mt-3 ml-1 display-none float-right">Обновить</button>' +
        '        <button name="" id="card-button-cancel-title"class="btn btn-secondary card-button-add-description mt-3 ml-1 display-none float-right">Отмена</button>' +
        '       </div>' +
        ...
        '             <button  data-toggle="modal" data-target="#DeleteCard"  name="MessageBoxModalAlert" class="btn btn-danger card-button-due-date mt-1 delete-card" data-dismiss="modal" data-value="' + card_id + '" id="delete-card">Удалить</button>'
